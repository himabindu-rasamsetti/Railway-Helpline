...
while( $row = mysqli_fetch_assoc($result) ){
			$pid = $row['absid'];
            echo "<tr><td><a href='admin-view-project.php?id=$pid'>". $row['adomain'] ."</a></td>";
			echo "<td><a href='admin-view-project.php?id=$pid'>". $row['atitle'] ."</a></td>";
			echo "<td><a href='admin-view-project.php?id=$pid'>". $row['batchid'] ."</a></td>";
			echo "<td><a href='admin-view-project.php?id=$pid'>". $row['ainstitute'] ."</a></td>";
			echo "</tr>";
		  }
